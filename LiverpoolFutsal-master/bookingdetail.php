...
<body>
    ...
    $query = "select * from booking_price where transnum = $transnum";
    $query_run = mysqli_query($db_connection,$query);
    $row = mysqli_fetch_assoc($query_run);
    $tgl = $row['tgl'];
    ...
    <div class="card shadow-sm mt-3 ml-4 mb-5 mr-4" style="width:900px; max-width: 90%">
        <div class="card-body">
            <div class=border-bottom>
                <div class="row">
                    <div class="col ">
                        <img src="res/img/1.png" width="100" height="57" alt="Flowers in Chania">
                    </div>
            ...
            <div class="mt-3 mb-1">
                <div class="mb-4">
                    ...
                    <h4>Rs. <?php echo money_format($price);?></h4>                    
                </div>
            </div>
        </div>       
    </div>
